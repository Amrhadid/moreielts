          ...
          <DropdownMenu.Root>
            ...
            <DropdownMenu.Portal>
              ...
              >
                ...
                <DropdownMenu.Separator className="my-1 h-px bg-line" />
                {/* TODO(backend): wire to real sign-out once auth exists. */}
                <DropdownMenu.Item className="cursor-pointer rounded-md px-3 py-2 text-sm text-muted outline-none data-[highlighted]:bg-paper">
                  Sign out
                </DropdownMenu.Item>
              </DropdownMenu.Content>
            </DropdownMenu.Portal>
